...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('practice_attempt', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Attempt.user'
        db.delete_column('practice_attempt', 'user_id')
