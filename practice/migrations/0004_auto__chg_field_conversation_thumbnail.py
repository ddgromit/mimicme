...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Conversation.thumbnail'
        db.alter_column('practice_conversation', 'thumbnail', self.gf('django.db.models.fields.files.FileField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Conversation.thumbnail'
        db.alter_column('practice_conversation', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
